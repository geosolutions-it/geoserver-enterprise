...
public class WicketTestApplication extends WebApplication {
    ...
    static String wtapath = WicketTestApplication.class.getPackage().getName()
            .replaceAll("\\.", "/");

    static String gsapath = GeoServerApplication.class.getPackage().getName()
            .replaceAll("\\.", "/");
    static {
    ...
    /**
     * <p>
     * Starts a Wicket tester application that will allow for quick interactive testing of the {@link Component} generated by the factory (may be a
     * {@link Page}, in that case the home page will redirect to it).
     * </p>
     * <p>
     * The application will be hosted on path "/", port 8080
     * </p>
     * 
     * @param factory
     */
