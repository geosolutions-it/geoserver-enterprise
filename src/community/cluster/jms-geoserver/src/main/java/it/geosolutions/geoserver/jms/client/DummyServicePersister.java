...
public class DummyServicePersister extends ConfigurationListenerAdapter  {
    ...
    public DummyServicePersister(GeoServer geoServer, List<XStreamServiceLoader> loaders) {
