...
public class KMLPPIOTest extends GeoServerTestSupport {
    ...
    public void testEncodeLinestring() throws Exception {
        ...
        assertEquals("-92.99887316950249,4.523788751137377,0 -92.99842243632469,4.524241087719057,0", xpath.evaluate("//kml:LineString/kml:coordinates", dom));
        assertEquals("t0001 ", xpath.evaluate("//kml:ExtendedData/kml:Data[@name='id']/kml:value", dom));
    }
    ...
    public void testEncodePolygon() throws Exception {
        ...
        // print(dom);
        checkValidationErorrs(dom, "./src/test/resources/org/geoserver/wps/ppio/ogckml22.xsd");
        assertEquals("-1.0,5.0,0 2.0,5.0,0 2.0,2.0,0 -1.0,2.0,0 -1.0,5.0,0", 
                xpath.evaluate("//kml:Placemark[@id='BasicPolygons.1107531493644']//kml:LinearRing/kml:coordinates", dom));         
    }
    ...
    public void testEncodePoints() throws Exception {
        ...
        assertEquals("t0000", xpath.evaluate("//kml:ExtendedData/kml:Data[@name='id']/kml:value", dom));
        assertEquals("-92.99954926766114,4.52401492058674,0", 
