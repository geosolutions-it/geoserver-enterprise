...
public class AlgebricProcess implements GSProcess {
    ...
    public GridCoverage2D execute(
        ...
        // extract the collected coverages and use them for the arithmetic operation
        ...
        for (String key : coveragesList) {
            String elementString = catalog.getCoverageByName(key).prefixedName();
            GridCoverage2D coverage = mapCoverage.get(elementString);
            if (coverage != null) {
